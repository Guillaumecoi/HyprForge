...
### Variables ###
# Default values
def_lang, def_temp, def_time, def_wind = 'en', 'c', '24h', 'km/h'
...
# Preferred home-managed location: $HOME/share/environnement.env
env_path_home = os.path.join(os.path.expanduser("~"), ".local", "share", "environnement.env")
loaded_home = load_env_file(env_path_home)
